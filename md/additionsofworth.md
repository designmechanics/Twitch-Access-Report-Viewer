# Additions of Worth - Feature Roadmap & TODO
...
- [x] **Loyalty Archetype Badge**: Community viewer badges dynamically calculated from dataset metrics (e.g. *Night Owl Lurker*, *Giga Chatter*, *Hype Train Conductor*, *Variety Hopper*).

## 3. Financial & Micro-Transaction Ledger ("The Wallet Check")
- [x] **Lifetime Twitch Spend Breakdown**: Cumulative real-world currency estimation across Subscriptions (Tier 1/2/3, Prime Gaming), Gifted Subs, and Bits badge tiers.
- [x] **Channel Support Leaderboard**: Ranking of creators who received the largest financial support from the viewer.
- [x] **Sub Streak & Prime Usage Tracker**: Visualiser for active/historic streaks and unclaimed or utilised monthly Prime subscriptions.

## 4. Moderation, Bans & Timeout History ("The Police Record")
- [x] **Automod & Timeout Log**: Ingest moderation files to display channel timeouts, deleted messages, and ban events with exact timestamps and channels.
- [ ] **Caps & Chat Velocity Filter**: Breakdown of message frequency and flagged patterns.

## 5. Channel Points & Prediction ROI ("The Gambler's Ledger")
- [x] **Prediction Win/Loss Ratio**: Cumulative points wagered vs. points won across channel predictions.
- [x] **Biggest Win & Worst Beat**: Highlight biggest single payout and biggest point wipeout.
